...
export function ThemeInitializer() {
  ...
  useEffect(() => {
    ...
    root.style.setProperty("--theme-table-felt-start", theme.colors.tableFelt.start);
    ...
    root.style.setProperty("--theme-table-edge-accent", theme.colors.tableEdgeAccent);
    root.style.setProperty("--theme-dashboard-bg", theme.colors.dashboardBackground);
    root.style.setProperty("--theme-dashboard-card", theme.colors.dashboardCard);
    root.style.setProperty("--theme-dashboard-card-border", theme.colors.dashboardCardBorder);
    root.style.setProperty("--theme-dashboard-accent", theme.colors.dashboardAccent);
