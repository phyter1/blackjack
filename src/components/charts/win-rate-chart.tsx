  ...
  return (
    <Card className="bg-gray-900 border-gray-700">
      <CardHeader>
        ...
        <CardDescription>
          Overall Win Rate:
          <span className={avgWinRate >= 50 ? "text-green-500 ml-2 font-semibold" : "text-red-500 ml-2 font-semibold"}>
            ...
            <Tooltip
              ...
              formatter={(value: any, name: string) => {
                if (typeof value === "number") {
                  const label = name === "movingAvgWinRate" ? "5-Session Avg" : "Session Win";
